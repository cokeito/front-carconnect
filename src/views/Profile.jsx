...
export const Profile = () => {
  ...
  const n_products = products.slice(0, 6)
  return (
    <>
      <Layout>
            ...
            <div className="flex gap-10">
              <div className="self-start pb-10 max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto bg-white shadow-xl rounded-lg text-gray-900">
                ...
                <div className="text-center mt-2">
                  <h2 className="font-semibold">coke</h2>
                  <p className="text-gray-500">coke@mta.cl</p>
                </div>
              ...
              <Items title="Mis Vehiculos" products={n_products} className="lg:grid-cols-2 sm:grid-cols-1" />
            </div>
          </div>
